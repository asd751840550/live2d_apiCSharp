...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://github.com/asd751840550');
...
function waifuWelcome(){
    ...
    var SiteIndexUrl = window.location.protocol+'//'+window.location.hostname + ":"+ window.location.port+'/';  // 自动获取主页
...
function loadModel(modelId, modelTexturesId){
    ...
    loadlive2d('live2d', '//localhost:9262/api/Home/GetModel?id='+modelId+'-'+modelTexturesId, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
...
function loadRandModel(){
    ...
    $.ajax({
        cache: false,
        url: '//localhost:9262/api/Home/'+modelTexturesRandMode+'_textures/?id='+modelId+'-'+modelTexturesId,
...
function loadOtherModel(){
    ...
    $.ajax({
        cache: false,
        url: '//localhost:9262/api/Home/'+modelTexturesRandMode+'/?id='+modelId,
        dataType: "json",
        success: function (result){
